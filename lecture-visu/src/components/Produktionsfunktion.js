...
function Produktionsfunktion() {
  ...
  return (
    <div style={{ textAlign: 'center' }} id="Produktionsfunktion">
      ...
      {/* Plotly Plot */}
      <div class ="plot-phases">
        <Produktionsplot data = {data} tabIndex={tabIndex}></Produktionsplot>
        ...
        {/* Tabs Section */}
                ...
                <Box sx={{ width: '100%', bgcolor: 'background.paper', marginTop: 3 }}>
                    ...
                    {tabIndex === 0 && (
                    <Box p={3} sx={{textAlign: "left", fontSize: "0.2", padding:0}}>
                        ...
                        <BlockMath math={`x'' = \\frac{d^2x}{dr^2} = ${6*a} r + ${2*b}`} />
                        <p class = "solution">r = {Math.round(data.x_values[0] * 100) / 100}</p>
                        <h5>Einsetzen in:</h5>
